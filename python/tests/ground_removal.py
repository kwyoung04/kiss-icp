...
class Processor:
    ...
    def __init__(self, n_segments=70, n_bins=30, r_max=15, r_min=0.0,
                 line_search_angle=0.0, max_dist_to_line=0.0,
                 max_slope=2.0, max_error=0.1, long_threshold=1,
                 max_start_height=0.001, sensor_height=1.73):
